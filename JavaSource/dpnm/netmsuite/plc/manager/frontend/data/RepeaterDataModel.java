...
public class RepeaterDataModel extends PLCNodeDataModel{
	...
	, _OutAcks	,_InFails	, _OutFails
	, _InAGCGain	, _OutAGCGain
	, _InPhyBPC	, _OutPhyBPC
	, _InSpeed	, _OutSpeed
	, _InError	, _OutError
	, _LinkedNodeNum	, _RTSCTSStatus;
	...
	public RepeaterDataModel(String macAddr, String inPkts, String outPkts,
			String inAcks, String outAcks, String inFails, String outFails,
			String inAGCGain, String outAGCGain,
			String inPhyBPC, String outPhyBPC, String inSpeed, String outSpeed,
			String inError, String outError,
			String parentMAC, String linkedNodeNum, String RTSCTSStatus,
		...
		super(null, macAddr, PLCInfoDefinition.NODETYPE_REPATER, inPkts, outPkts, parentMAC);
		
		_InAcks = inAcks;
		_OutAcks = outAcks;
		_InFails = inFails;
		_OutFails = outFails;
		_InAGCGain = inAGCGain;
		_OutAGCGain = outAGCGain;
		_InPhyBPC = inPhyBPC;
		_OutPhyBPC = outPhyBPC;
		_InSpeed = inSpeed;
		_OutSpeed = outSpeed;
		_InError = inError;
		_OutError = outError;
	...
	public String toString(){
		return "Repeater " + _MACAddressName;
	}
//	public Object clone(){
//	RepeaterDataModel copiedData = new RepeaterDataModel();
//	
